...
mixin _$ItemVO {
  ...
  int get startTier => throw _privateConstructorUsedError;
  int get endTier => throw _privateConstructorUsedError;
...
abstract class $ItemVOCopyWith<$Res> {
  ...
  @useResult
  $Res call({String id, String name, int startTier, int endTier});
}
    ...
    return _then(_value.copyWith(
      ...
      name: null == name
          ...
          : name // ignore: cast_nullable_to_non_nullable
              as String,
      startTier: null == startTier
          ? _value.startTier
          : startTier // ignore: cast_nullable_to_non_nullable
              as int,
      endTier: null == endTier
          ? _value.endTier
          : endTier // ignore: cast_nullable_to_non_nullable
              as int,
    ) as $Val);
  }
}
...
class _$_ItemVO implements _ItemVO {
  ...
  @override
  String toString() {
    return 'ItemVO(id: $id, name: $name, startTier: $startTier, endTier: $endTier)';
  }
  ...
  bool operator ==(dynamic other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            ...
            (identical(other.startTier, startTier) ||
                other.startTier == startTier) &&
            (identical(other.endTier, endTier) || other.endTier == endTier));
  }

  @JsonKey(ignore: true)
  @override
  int get hashCode => Object.hash(runtimeType, id, name, startTier, endTier);
...
abstract class _ItemVO implements ItemVO {
  factory _ItemVO(
      ...
      required final int startTier,
      required final int endTier}) = _$_ItemVO;
